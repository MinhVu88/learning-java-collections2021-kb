// Sec 2: Foundations
package com.linkedinlearning.kevinbowersox.sec2.pt_5_8;

import java.util.ArrayList;
import java.util.Collection;

import com.linkedinlearning.kevinbowersox.sec1.Room;

public class GenericTyping {
	public static void main(String[] args) {
		// a raw-type collection has no data type info about the elements it holds (not recommended)
		...
		// a collection that uses generic type arg to indicate the type of elements it holds (recommended)
